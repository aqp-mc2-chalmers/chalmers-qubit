...
\begin{equation}
\Big|\int\_{0}^{t}[\Omega^x(t')+i\Omega^y(t')]\mathrm{d}t'\Big|=\pi.
\end{equation}
...
\begin{equation}
\frac{H\_\mathrm{coupling}(t)}{\hbar} = g(t)(\ket{10}\bra{01}+\ket{01}\bra{10}),
\end{equation}
...
\begin{equation}
\frac{H\_\mathrm{coupling}(t)}{\hbar} = g(t)(\ket{20}\bra{11}+\ket{11}\bra{20}).
\end{equation}
...
\begin{equation}
t\_\mathrm{gate} = \frac{1}{\sqrt{2}2g}.
\end{equation}
